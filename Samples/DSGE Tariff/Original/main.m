...
target_m = 0.155 *NT_y; % target imports = percentage of tradeable GDP
slopePC  = 0.0055; %obtained by setting  price adjustment cost vxphi to 1636.
vxphi    = (1/sigma+psi)*epsi/slopePC; %decide slopePC in advance, then obtain vxphi.


% Implied theta
fun = @(theta) epsi*theta/((1-theta)*(1-beta*theta)) - vxphi;       % f(theta)= epsi...
